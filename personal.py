...
# --- Schedule K-1 (Form 1065) grouping ---
    ...
    if income:
        ...
        # ------------------------------------------------------------------
            ...
            # High-confidence detection
                        ...
                        if form_matches:
                            append_and_bookmark(real_entry, account_node, form_matches[0], owner_override=None)
                        else:
                            append_and_bookmark(real_entry, account_node, "", with_bookmark=False, owner_override=None)
  ...
  # done with this form; go to next
            ...
            for j, entry in enumerate(filtered_grp, 1):
                ...
                # normal case
                # --- NEW FEATURE: TP/SP tagging ---
                # Extract text for this page
                page_text = extract_text(path, idx)

                # Detect whether this page belongs to TP or SP
                owner = detect_ssn_owner(page_text, tp_ssn, sp_ssn)
